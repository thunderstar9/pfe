...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 27532 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 28248 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 12214 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 11117 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 11905 };
      post.blog = blog;
      const tag: ITag = { id: 28634 };
      post.tags = [tag];
