...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '98c33c99-841a-40ca-bd02-2e64e9904b49' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('fa8b6443-c72a-4f0a-8b99-b7f20930b294');
      cy.get(`[data-cy="name"]`).should('have.value', 'fa8b6443-c72a-4f0a-8b99-b7f20930b294');
